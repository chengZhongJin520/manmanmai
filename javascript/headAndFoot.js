...
define(['jquery'], function ($) {
  var set = function (obj) {
    ...
    if (loc === 'index' || loc === 'category' || loc === 'product' || loc === 'productlist') {
      var header = '<header class="clearfix mmm_header " id="linklink"><div class="logo fl"><a href="index.html"><img src="../pages/images/header_logo.png" alt=""></a></div><div class="appdown fr"><a href="javascript:;"><img src="../pages/images/header_app.png" alt=""></a></div></header>';
    } else {
      var pageTitle = {
        moneyctrl: '省钱控 - 最新优惠',
